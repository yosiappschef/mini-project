//
//  GridlayoutSectionCollectionViewCell.swift
//  sampleCRUD
//
...
class GridlayoutSectionCollectionViewCell: UICollectionViewCell {
    static let cellIdentifier = "GridCollectionViewCell"
